...
spatial_variogram_kriging <- function(df, flex_vgm = FALSE, flex_fit = TRUE,
                                      cutoff = NA, width = NA,
                                      vgm_model = "Mat",
    ...
    # Error message if variogram params not provided
    # and flex arguments are False
    if ((any(is.na(c(cutoff, width))) && flex_vgm == FALSE) ||
