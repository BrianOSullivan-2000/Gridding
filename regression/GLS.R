...
GLS <- function(df, formula, fit_vgm, multi_GLS = F, n_iter = 5,
                plot = F, readout = F, ...){
  
  # df                      -data frame of response variable and covariates
  # formula                 -regression formula
  
  # fit_vgm                 -variogram (covariance structure of spatial process)
...
spatial_variogram_GLS <- function(df, flex_vgm = F, flex_fit = F,
                                  cutoff = NA, width = NA,
                                  vgm_model = "Mat",
