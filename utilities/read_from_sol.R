...
read_from_sol <- function(sql_query_string,
    ...
    # my laptop (.Renviron). For this function to work, you also need to be
    # able to ssh into sol without a password, otherwise the code hangs
    # and doesn't work. This can be done by setting up a private key on
    # your local laptop and putting a matching public key on to sol.
